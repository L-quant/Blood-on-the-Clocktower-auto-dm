...
- `NewRoomManager(ctx context.Context, st *store.Store, logger *zap.Logger, metrics *observability.Metrics, snapshotInterval int64, autoDM *agent.AutoDM, composer game.Composer) *RoomManager` → 创建房间管理器
