...
var TroubleBrewingRoles = []Role{
	...
	{ID: "undertaker", Name: "Undertaker", NameCN: "掘墓人", Team: TeamGood, Type: RoleTownsfolk, AbilityType: AbilityNight, OtherNightOrder: 56, NightActionType: ActionInfo, Ability: "Each night*, you learn which character died by execution today.", AbilityCN: "每个夜晚*，你会得知今天被处决的玩家的角色。"},
