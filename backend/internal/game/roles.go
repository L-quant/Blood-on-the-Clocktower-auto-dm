...
var TroubleBrewingRoles = []Role{
	...
	// Outsiders
	{ID: "butler", Name: "Butler", NameCN: "管家", Team: TeamGood, Type: RoleOutsider, AbilityType: AbilityNight, FirstNightOrder: 38, OtherNightOrder: 55, Ability: "Each night, choose a player (not yourself): tomorrow, you may only vote if they are voting too.", AbilityCN: "每个夜晚，选择一名玩家（非自己）：明天，只有当他们投票时你才能投票。", Reminders: []string{"Master"}},
